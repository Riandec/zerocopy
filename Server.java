...
public class Server {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port);
            ...
            while (true) {
                ...
                if (clientSocket.isConnected()) {
                    ...
                    System.out.println("ClientSocketChannel#" + clientN + " connected -> " + clientChannel);
                    new ClientHandler(clientSocket,clientChannel,clientN).start();
                }
            }
        } catch (Exception e) {
    ...
    private static class ClientHandler extends Thread {
        ...
        public ClientHandler(Socket clientSocket, SocketChannel clientChannel, int clientN) throws IOException {
        ...
        public void zeroCopySend(File file){
            try(FileChannel sourceFile = new FileInputStream(file).getChannel()){
                ...
                while (position < file.length() && (count = sourceFile.transferTo(position, sourceFile.size(), clientChannel)) > 0) {
            ...
            try {
                while ((clientCommand = inputFromClient.readLine()) != null) {
                    ...
                    if (clientCommand.equals("/filelist")) {
                        ...
                        System.out.println("Client#" + clientN + " selected type: " +clientType);
